...
function showAll(){
  for (var j = 0; j < worksheetsList.length; j++){
    //worksheetsList[j].style.height = "";
    //worksheetsList[j].getElementsByTagName("div")[0].style.height = "";
    //worksheetsList[j].getElementsByTagName("div")[0].style.width = "100%";
    //worksheetsList[j].getElementsByTagName("div")[0].getElementsByTagName("iframe")[0].style.transform = "scale(1)";
  }
  toggleWorksheets(0);
}
