...
function showAll(){
  for (var j = 0; j < worksheetsList.length; j++){
    worksheetsList.getElementsByTagName("div")[0].style.height = "";
    worksheetsList.getElementsByTagName("div")[0].getElementsByTagName("div")[0].style.height = "";
    worksheetsList.getElementsByTagName("div")[0].getElementsByTagName("div")[0].style.width = "100%";
    worksheetsList.getElementsByTagName("div")[0].getElementsByTagName("div")[0].getElementsByTagName("iframe")[0].style.transform = "scale(1)";
  }
}
